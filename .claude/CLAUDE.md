...
| raccolta | WU199 | report_raccolta — lettura Gathering Report per produzione/ora precisa | MEDIA | 🟡 FASE 2 IN PROD, reset completo riarmato 10/07/2026. Piano 3 fasi: (1) reset ✅, (2) lettura+storage+scroll ✅ implementata (232+ righe raccolte prima del nuovo reset), (3) sostituzione algoritmo produzione — non iniziata. WU199quinquies: sanity check capacità nominale (`_CAPACITA_MAX`) contro bleed OCR icona risorsa. WU199sexies: toggle "Sort Mail" forzato OFF (non riordina righe, solo vista a categorie) + "Read and claim all"+"Delete read" al posto di "Delete" diretto — **riavvio prod da programmare**. Dettagli completi in `docs/issues/raccolta.md` |
