...
| ocr-vision | WU192 | FauMorfeus — splash "Doomsday x Fairy Tail" (v1.58.0) non catalogato, boot abortito dopo 300s | MEDIA | 🆕 APERTA 05/07/2026 — 3 episodi in un giorno (17:51/20:40/23:28), sempre stessa splash screen mai catalogata, zero raccolta per quel giro. Isolato a FauMorfeus (altre istanze 1 sola occorrenza in 29h). Decisione utente pendente su fix. Dettagli in `docs/issues/ocr-vision.md` (WU192) |
