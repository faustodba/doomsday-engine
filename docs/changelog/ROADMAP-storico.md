# ROADMAP — storico cronologico (archivio)

> Archivio verbatim della cronologia ROADMAP (sessioni, issue dettagliate, "Fix applicati")
> spostato qui il 07/06/2026 nella riorganizzazione documenti. `ROADMAP.md` ora tiene solo
> lo stato corrente + strutturale. Lo **stato issue per tematica** è in [`../issues/`](../issues/README.md).
