    ...
    def run(self, ctx: TaskContext,
        ...
        if libere == 0:
            ...
            try:
                ...
                pass
            # 06/05 — diagnostico: confronta elapsed dall'ultimo invio reale
            # con T_marcia stimato. Se elapsed >> T_marcia, il dato slot=pieno
            # è SOSPETTO (OCR HOME sbagliato? schieramento manuale?) → log warn.
            try:
